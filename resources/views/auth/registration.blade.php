...
<body>
    <nav class="bg-white w-full fixed border-gray-200 px-8 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        ...
        <div class="w-full px-4 flex flex-col items-center">
                ...
                <div class="relative py-2">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-2.5 pointer-events-none">
                        <img aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                            viewBox="0 0 20 20" src="./images/user.png">
                    </div>
                    <input type="text" id="input-group-1" name="name"
                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-blank block focus:border-blank pl-10 py-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="w-1/4 relative py-2 px-4 items-center justify-center">
                <div class="relative py-2">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-2.5 pointer-events-none">
                        <img aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                            viewBox="0 0 20 20" src="./images/telpon.png">
                    </div>
                    <input type="integer" id="input-group-1" name="no_telepon"
                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-blank focus:border-blank block pl-10 py-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="w-1/4 relative py-2 px-4 items-center justify-center">
                <div class="relative py-2">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-2.5 pointer-events-none">
                        <img aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                            viewBox="0 0 20 20" src="./images/key.png">
                    </div>
                    <input type="Password" id="input-group-1" name="password"
                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-primary focus:border-blank block pl-10 py-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
